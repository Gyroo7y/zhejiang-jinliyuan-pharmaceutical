...
- After the release record was committed as `92666cf0680fd0859063980ad196ff09f188b7dd`, the same bound production site was redeployed from final `main` runtime code. Current immutable production deploy: `6a8fd2602f513c66ba3826e0` at `https://6a8fd2602f513c66ba3826e0--zhejiang-jinliyuan-pharmaceutical.netlify.app/`. Its deployed public bundle is identical to the final Git runtime code; the subsequent release-record commit changes Markdown only, and Markdown is explicitly excluded from Netlify upload.
